...
if(count($erro) == 0) {
  ...
  $query = "UPDATE container SET cliente = :cliente, numero = :numero, tipo = :tipo, status = :status, categoria = :categoria WHERE id = '$id'";
  ...
  $erro[] = "Contêiner nâo cadastrado!"; 
	...
	$query2 = $pdo->query("SELECT * from container WHERE id = '$id'");
        ...
        <div class="col-12">
          ...
          <form action="" method="post" class="card">
            ...
            <div class="card-header">
              <h4 class="card-title">Editar Contêiner</h4>
            </div>
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="row">
                    <div class="mb-4">
                      <div class="form-selectgroup form-selectgroup-pills">
                        ...
                        <label class="form-selectgroup-item">
                          <input type="radio" id="tipo" name="tipo" value="20" class="form-selectgroup-input" 
                          <?php if ($tipo == "20"){ ?>
                              checked
                              <?php
                            }
                   ...
                   <div class="col-md-12 col-xl-12">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="row g-2">
                        <div class="col">
                          <input type="text" name="cliente" value="<?php echo $cliente;  ?>" class="form-control form-control-rounded mb-2" placeholder="Nome do Cliente">
                        </div>
                      </div>
                      <div class="col-md-12 col-xl-12">
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="numero"  value="<?php echo $numero;  ?>" class="form-control form-control-rounded mb-2" maxlength="11" OnKeyPress=""placeholder="TEST1234567">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="col-xl-4">
                        <div class="row">
                          <div class="mb-4">
                            <div class="form-selectgroup form-selectgroup-pills">
                              ...
                              <label class="form-selectgroup-item">
                                <input type="radio" id="status" name="status" value="Vazio" class="form-selectgroup-input"
                                 <?php if ($status == "Vazio"){ ?>
                                  checked
                                  <?php
                                     }
                       ...
                       <div class="mb-3">
                      <label class="form-label">Status<?php echo $categoria; ?></label>
                      <div class="col-xl-4">
                        <div class="row">
                          <div class="mb-4">
                            <div class="form-selectgroup form-selectgroup-pills">
                              ...
                              <label class="form-selectgroup-item">
                                <input type="radio" id="categoria" name="categoria" value="Importação" class="form-selectgroup-input"
                                 <?php if ($categoria == "Importação"){ ?>
                                  checked
                                  <?php
                                     }
                                ?>>
