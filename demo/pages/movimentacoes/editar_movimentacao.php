...
$query2 = $pdo->query("SELECT * from movimentacao WHERE id = '$id' ");
...
if($total_reg2 > 0){ 
  ...
  $id = $res2[0]['id'];
  $tipo = $res2[0]['tipo'];
  $dhinicio = $res2[0]['dhinicio'];
  $dhfim = $res2[0]['dhfim'];
  $idcontainer = $res2[0]['idcontainer'];
    ...
    <div class="page-body">
      <div class="container-xl">
           ...
           <div class="mb-3">
            ...
            <select type="text" class="form-select" placeholder="Buscar..." name="idcontainer" id="select-tags">
              ...
              if($total_reg > 0){ 
                ...
                <option <?php if($idcontainer == $res[$i]['id']){ ?> selected <?php } ?>  value="<?php echo $res[$i]['id'] ?>"><?php echo $numero; ?></option>
        ...
        <div class="mb-3">
          ...
          <div class="row g-2">
            <div class="col">
              <input type="text" name="dhinicio" value="<?php echo date('d/m/Y H:i', strtotime($dhinicio)); ?>" class="form-control form-control mb-2">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="row g-2">
              <div class="col">
                <input type="text" name="dhfim"value="<?php echo date('d/m/Y H:i', strtotime($dhfim)); ?>" class="form-control form-control mb-2" placeholder="Data e Hora">
              </div>
            </div>
